...
void main(float3 position : POSITION, float2 tex_coord : TEXCOORD0, float3 instance_position : POSITION1, out float4 positionOut : SV_POSITION, out float2 tex : TEXCOORD0)
{
