...
namespace PMG::Networking {
    ...
    */
    ...
    void CooldownPacket::Read(std::vector<uint8_t>* data) {
        ...
        std::memcpy(&cooldown, data->data() + offset, sizeof(cooldown));
        offset += sizeof(cooldown);

        std::memcpy(&total_cooldown, data->data() + offset, sizeof(total_cooldown));
    }
    ...
    void CooldownPacket::Write(std::vector<uint8_t>* data) {
        ...
        std::memcpy(data->data() + offset, &cooldown, sizeof(cooldown));
        offset += sizeof(cooldown);

        std::memcpy(data->data() + offset, &total_cooldown, sizeof(total_cooldown));
    }
}